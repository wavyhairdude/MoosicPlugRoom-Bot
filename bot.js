/**
 *Original by Yamache, modified heavily by TFS Network
 */
...
return sock.msg(data);
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/lang/langIndex.json", function (json) {
...
return str;
    ...
    var botModifier = "TFS Network"
    var botCreatorIDs = ["6137690","4554889"];
    ...
    var basicBot = {
        ...
        name: "TFS Bot",
        loggedInID: null,
        scriptLink: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/bot.js",
        cmdLink: "No current list",
        chatLink: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/lang/en.json",
        chat: null,
        loadChat: loadChat,
        ...
        settings: {
            ...
            skipReasons: [
                ...
                ["awful", "The song you played was awful! "],
            ...
            commandLiteral: "!",
            blacklists: {
                NSFW: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/blacklists/NSFW.json",
                OP: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/blacklists/OP.json",
                BANNED: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/blacklists/BANNED.json",
                AWFUL: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/blacklists/AWFUL.json"
            }
        },
        room: {
            name: null,
          ...
          announceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                            ...
                            API.sendChat(subChat(basicBot.chat.announce, {question: argument}));
                     }
                }
            },
            ...
            scCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.scLink === "string")
                            API.sendChat(subChat(basicBot.chat.soundcloud, {link: basicBot.settings.scLink}));
                    }
                }
            },
            
            gplusCommand: {
                command: ['g+', 'google+', 'googleplus'],
                rank: 'user',
                type: 'exact',
                functionality: function (chat, cmd) {
                    if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (typeof basicBot.settings.scLink === "string")
                            API.sendChat(subChat(basicBot.chat.gplus, {link: basicBot.settings.gplusLink}));
                    }
                }
            },
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        $.get("https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/lang/langIndex.json", function (json) {
                            ...
                            if (typeof link === "undefined") {
                                API.sendChat(subChat(basicBot.chat.langerror, {link: "https://rawgit.com/Dino9Inc/MoosicPlugRoom-Bot/dev/lang/langIndex.json"}));
                            }
                            else {
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot was created by ' + botCreator + ', but is now maintained by ' + botMaintainer + ', but was modified by ' + botModifier + ".");
                    }
                }
            },
            ...
            wazupCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me https://media.giphy.com/media/9HBduC3ZIgrG8/giphy.gif');
                    }
                }
            },
